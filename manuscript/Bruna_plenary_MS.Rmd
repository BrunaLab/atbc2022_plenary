...
> _"This manuscript is better suited to a specialized journal focusing on tropical ecosystems."_ 

1. This feedback from an Editor is one with which I am sure many members of the Association for Tropical Biology & Conservation (ATBC) are familiar.

2. The implication was clear - research on tropical systems is a specialized subdiscipline of the biological sciences (Figure 1a). As such, the results are narrower in scope and less broadly relevant to the readers of "general" ecological journals.^[I've yet to meet someone that's been told their manuscript should be submitted to a journal specializing on temperate ecosystems.] 

3. Here I revisit this long-established and ubiquitous view - that Tropical Biology is a specialized subdiscipline of the biological sciences - which by implication is narrow in scope with results are less broadly applicable those of work conducted in other locations. 

4. This is by no means intended to be a comprehensive historical overview, nor am I the first to have wrestled with questions about the breadth, novelty, and status of tropical biology [@janzenFutureTropicalEcology; @robinson1978tropical; @zukTemperateAssumptionsHow2016]. 

5. Instead, my goal is to test the implicit assumption underlying these prior discussions: That _"Tropical"_ Biology is indeed a distinct discipline.

<!-- 1. The adjective "Tropical" in our Association's name implies specialization.  -->

## 1. Why the answer in *'No'*

One means of evaluating if tropical biology is a distinct academic discipline is by considering the communities into which scientists self-organize. Scholarly societies and journals two examples of these communities such community; their establishment requires both an intellectual pursuit with which individuals identify and a critical mass of like-minded individuals in search of community. Some of these communities coalesce around broad conceptual domains (e.g., Evolutionary Biology, Conservation Biology, Integrative Biology; Fig. 2a). Still others bring together individuals from different conceptual domains but sharing an interest in a particular study system (e.g., birds, mammals, islands, grasslands; Fig. 2b). Finally, some scholarly societies comprise individuals grounded in a common methodological framework, though they may do so with disparate study systems or to address questions in distinct conceptual domains (e.g., molecular biology, mathematical biology, systematic biology; Fig 2c).   

'Tropical Biology' fails to align neatly with any of these constructs. _Tropical Biolgists_ investigate fundamental questions in a diversity of conceptual domains using a broad range of methodological frameworks and myriad focal systems. Moreover, _'The Tropics'_ are themselves challenging to conceptualize. Strictly speaking, they are the portion of the Earth's surface receiving at least one day of direct overhead sunlight per year - a band delineated by the Tropics of Capricorn (23°26'10.4" S) and Cancer (23°26'10.4" N). There is no consensus on an ecological definition of _'The Tropics'_, however, in no small part because the ranges of many 'tropical' species extend far beyond these boundaries^[Perhaps the most extreme examples are migratory birds such as the northern wheatear (_Oenanthe oenanthe_), which fly over 14,000 km from sub-Saharan Africa to their breeding grounds in the Arctic [@bairleinCrosshemisphereMigration252012]]. In a review of over 200 publications, @feeleyWhereEarthAre2018 identified at least eight distinct criteria by which authors defined _'The Tropics'_.   

How then is it that _Tropical Biology_ come to be seen as a distinct intellectual domain despite the lack the sharp boundaries around which scientific groups typically coalesce? And how did this study of the tropics come to be viewed as a biological subdiscipline instead of biology's foundation? After all, the tropics comprise an overwhelming majority of the planet's terrestrial biodiversity, ~40% of the terrestrial surface area, and by 2025 will be home to half of the human population. Put another way, why is there an _Association for Tropical Biology & Conservation_ instead of an _Association for Temperate Biology_?  
...
1. This perception of the tropics, and the resulting stereotypes, were  prevalent in North American and Europe at the time Ecology was consolidating as academic an discipline [@rabyColonialOriginsTropical2017].
1. Because Europe and North America were also where many of the field's pioneers were based, ecology's fundamental paradigms and theory were informed by and developed to explain patterns documented in the temperate zone [@cornerNeedDevelopmentTropical1946; @richardsProgrammeTropicalBiology1964; @richardsNeedDevelopmentTropical1946; @richardsWhatTropicsCan1963]^[is is also evident that much of our current teaching in ecology, as well as in other branches of biology, would be set in a truer perspective if more consideration were given to tropical vegetation and the conditions for plant growth in the tropics" [@richardsNeedDevelopmentTropical1946]; "The science of ecology developed first in central Europe, Scandinavia and Britain and very slightly later in the United States. The ideas and concepts with which it started were therefore inevitably based on the conditions in a temperate climate where the land has been long and intensively occupied by man." [@richardsWhatTropicsCan1963]].
1. These scientists were not ignorant of the tropics, indeed, many considered a trip to the tropics an essential rite of passage for their students ^["no education complete without trip to tropics." [@webbBiologyTropics1960]].
1. Other went even further - in in his 1945 Presidential Address to the Ecological Society of America, Orlando Park impressed upon his audience the importance of the tropics and encouraged ESA to establish a formal tropical program, _including a new journal focused on the biology of the tropics_ [@parkObservationsConcerningFuture1945].
1. But these efforts were often thwarted by the way in which tropical biology could quickly overwhelm temperate theory [@richardsWhatTropicsCan1963]^["Now at first sight the tropics are not a promising field for the ecologist. Tropical vegetation is reputed to be monotonous. It certainly contains far too many species for comfort and most of them are very difficult to identify" [@richardsWhatTropicsCan1963]] - wasn't a reorienting of the field towards these high-diversity ecosystems.
1. Instead, it was to translate the notion that "the tropics are _culturally_ unique" into the scientific truism that "the _biologically_ unique".^["In what way will a more intensive study of ecology in the tropics be likely to alter our present ecological ideas? In other words what can the tropics contribute to ecology?" [@richardsWhatTropicsCan1963]] 
1. Although the problems with this framing and its scientific consequences have been raised repeatedly [e.g., @ripleyPerspectivesTropicalBiology1967], it nevertheless persists to this day.  
...
<!-- and a trip to the jungle to become a right of passage for students.  -->
<!-- > In Brazil or India it's just called 'Biology. -->
...
1. Despite its origins as a colonial construct, Tropical Biology could still be a conceptually distinct field if the scientists studying tropical systems chose to investigate a suite of topics distinct from those studied by scientists working in other global regions. 

1. To assess this possibility I compared the titles and keywords of articles published from 1960-2022 in four 'Tropical' journals' (_Journal of Tropical Ecology_, _Biotropica_, _Tropical Ecology_, and _Tropical Conservation Science_) with those of tropical- and non-tropical articles from six journals  (_The American Naturalist_, _Evolution_, _Journal of Evolutionary Biology_, _Journal of Ecology_, _Ecology_, and _Journal of Animal Ecology_)  <!-- titles: , Keywords: 1976-2022   -->
...
In contrast, the the 20 most common key words in the "General Journals" were conceptual (e.g., _competiton_, _species diversity_, _climate change_, _sexual selection_). The exception were articles based on research conducted in the tropics, which also emphasized the location or system. 
